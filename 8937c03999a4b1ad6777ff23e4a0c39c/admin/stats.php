  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <p>This page holds some important statistice regarding the most sold item on the website as well as the most wanted seller.</p>
        <div class="row" style="margin-left:1em; margin-right: 1em;">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                <th scope="row">1</th>
                <td>Mgere albastre</td>
                <td>Fructe</td>
                <td>Mere</td>
                <td><a href="www.useruvietii.com">www.website.com/produsu_vietii</a></td>
                <td><a href="www.useruvietii.com">Vasile Grioras</a></td>
              </tr>
              <tr>
                <th scope="row">1</th>
                <td>Mgere albastre</td>
